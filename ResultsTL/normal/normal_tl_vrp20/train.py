...
class Trainer:
    def __init__(self, problem, graph_size, n_epochs, batch_size, nb_train_samples,
                 ...
                 d_ff, decode_mode, C, dropout, device, learning_rate, freq_save, freq_log, embed_demand, distribution
                 ):
...
if __name__ == "__main__":
    ...
    pretrained_tsp = "RL_TSP20_Epoch_100.pt"

    checkpoint = torch.load(pretrained_tsp, map_location=device)
    ...
    trainer = Trainer(problem,graph_size,n_epochs,batch_size,nb_train_samples,nb_val_samples,
                      ...
                      dropout,device,learning_rate, freq_save, freq_log, embed_demand, distribution)
